...
import beini.com.wifimanage.view.MyViewHolder;
...
public class RecycleAdapter extends RecyclerView.Adapter {
    ...
    public RecycleAdapter(Context context, List<Integer> lists) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MyViewHolder(inflater.inflate(R.layout.item_recycle, null, false));
    }
